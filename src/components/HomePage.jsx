    ...
    return (
        <div className="container mx-auto px-4 py-8">
            ...
            <div className="max-w-6xl mx-auto">
                <section className="bg-gray-50 rounded-lg p-12 text-center mb-12">
                    <h2 className="text-3xl font-semibold mb-4">Find Everything You Need</h2>
                    <p className="text-gray-600 mb-6">Browse our wide selection of products across multiple categories</p>
                    <Link 
                        to="/categories" 
